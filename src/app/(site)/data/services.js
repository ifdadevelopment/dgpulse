...
export const serviceProblems = {
  "website-designing-development": {
    heading: "Are These Problems Holding You Back? — Website Design & Development Version",
    description:
    ...
    items: [
      {
        ...
        desc:
          "If the design of a website is unattractive and is not responding appropriately, customers will not stay on the website. Customers expect an attractive and modern user interface and a good user experience on the website. Customers also expect clean layouts, fast page load times, and for the website to be responsive and mobile friendly. These are the basics every skilled web designer in Delhi NCR focuses on.",
        image: "/images/speed-slow.webp",
      },
      {
        title: "Slow Website Speed & Poor Performance",
        desc:
          "A slow website is a silent revenue killer. If your pages take more than 3 seconds to load, most visitors bounce — and Google ranks you lower in search results. A reliable web development company in Delhi ensures better performance.",
        image: "/images/unattractive.webp",
      },
      {
        title: "Low Website Conversion Rates",
        desc:
          "You’re getting visitors, but they don’t contact you, buy your products, or trust your business enough to take action. This is a conversion problem, not a traffic problem. Working with a web design company Delhi can help improve conversion flow.",
  ...
  "customize-crm-services": {
    ...
    items: [
      ...
      },
      {
        ...
        desc:
          "When your team forgets to follow up, sales are lost. A CRM with automated reminders ensures no lead is ever ignored — improving response time and customer satisfaction. Consistent action is what defines good CRM services.",
        image: "/images/missed-lead-follow--up.webp",
      },
      {
        title: "No Visibility of Sales Pipeline",
        desc:
          "Organizations often get inquiries from their clients, however, it is impossible to determine which leads are close to closing, what leads require follow-up, and where customers are getting stuck in the sales process, without having a defined sales pipeline. All of these issues fall under a CRM issue, not a marketing issue.",
        image: "/images/no-visibilty.webp",
      },
    ],
  },
  "mobile-app-development": {
    heading: "Are These Problems Holding You Back? — Mobile App Development Version",
    description:
    ...
    items: [
      {
        ...
        desc:
          "If an app ui looks old, feels unprofessional, or is difficult to navigate, users will uninstall it immediately. People expect modern UI, clean layouts, fast performance, and a friendly mobile experience. These are the fundamentals followed by every reliable app development company near me.",
        image: "/images/outdated.webp",
      },
      {
        title: "Slow Performance & App Crashes",
        desc:
          "A slow or unstable app is one of the primary reasons users abandon it. If your app takes too long to load or crashes during that time when the user uses that app , users will switch to competitors. Working with an experienced app development company ensures optimized code and smooth performance.",
        image: "/images/slow-performance.webp",
      },
      {
        title: "Low User Engagement & Poor Retention",
        desc:
          "You may get downloads, but if users don’t stay, it means the app is not providing value or ease of use. This is not a marketing issue — it’s a design and functionality issue. A skilled mobile app development company in Delhi helps increase engagement with better features and user flows.",
    ...
    items: [
      {
        ...
        desc:
          "If your graphics look old, confusing, or very low quality, people will ignore your brand. Customers want clean layouts, modern design, and visually appealing content that users engage in very easily. These are fundamentals followed by every reliable graphic design agency near me.",
        image: "/images/outdated1.webp",
      },
      {
        title: "Inconsistent Branding",
        desc:
          "When your logo, colors, fonts, and style don’t match across platforms, your brand loses authenticity and also visibility. A strong design system keeps everything consistent so your brand feels trustworthy and professional — something a quality graphic design agency in Delhi always focuses on.",
        image: "/images/incosistent.webp",
      },
      {
        title: "Low Engagement on Social Media",
        desc:
          "You may be posting regularly, but if your graphics are not eye-catching or attractive, No one pauses to look twice. This is not a posting problem — it’s a design problem. Good visual communication helps increase engagement and brand recall.",
    ...
    items: [
      {
        ...
        desc:
          "If your videos look old style, shaky, poorly edited, or messy, viewers can't see your videos till the end. People expect clean cuts, good pacing, clear audio, and modern visuals. These are basic standards every reliable video editing agency maintains.",
        image: "/images/low-quality.webp",
      },
      {
        title: "No Clear Story or Message",
        desc:
          "A video can have good footage, but without proper editing, the message gets lost. Good editing brings clarity, flow, and meaning — helping viewers understand your story within seconds.",
        image: "/images/no-clearity.webp",
      },
      {
        title: "Low Engagement & Poor Performance",
        desc:
          "You might post videos, but if they aren’t engaging, people won’t like, share, or stay and this will affect your business. This is not a platform issue — it’s a video editing issue. Strong visuals + clean storytelling = better retention.",
    ...
    items: [
      {
        ...
        desc:
          "If a person cannot find your website using Google or social media, how will they find what you offer? A company needs to use SEO to maintain its relevance against the competition and to help clients reach their target customers. To do this, many companies are using an experienced and trusted SEO Agency in Delhi.",
        image: "/images/low-online.webp",
      },
      {
        title: "Poor Lead Generation & Traffic",
        desc:
          "Traffic alone is not enough. You need the right audience, the right messaging, and the right funnel that connects your business. A good digital marketing agency helps you attract people who are actually interested in your services.",
        image: "/images/poor-lead1.webp",
      },
      {
        title: "No Clear Digital Strategy",
        desc:
          "Marketing without a well-defined strategy leads to confusion and disorganization in your promotional activities. Digital marketers with a systematic approach have good knowledge of how the website, advertisements and content all work best when they are integrated into one cohesive unit.",
    ...
    items: [
      {
        title: "Low-Quality or Unprofessional Videos",
        desc:
          "If you post content that looks old style, poorly designed, and not on-brand, people will scroll past your posts in an instant. Customers expect visually appealing, professional, and clearly defined messaging, along with consistently scheduled posts from businesses. This leads many businesses to search in Google for an SMM company near their location to provide them with high-quality and consistent content.",
        image: "/images/low-quality1.webp",
      },
      {
        title: "No Proper Strategy or Targeting",
        desc:
          "Posting without a clear plan rarely brings results. Social media needs direction — understanding your audience, choosing the right content, and using data to guide decisions. This is where a good Social Media Marketing Agency in Delhi makes all the difference.",
        image: "/images/no-proper-strategy.webp",
      },
      {
        title: "Low Engagement & No Growth",
        desc:
          "You may be posting, but if people aren’t interacting, sharing, or following, something is missing. This is not a “platform problem” — it’s a content and strategy problem. Strong creative execution is key to growth.",
        image: "/images/low-engagement1.webp",
      },
    ],
  },
  "gmb-listing": {
    heading: "Are These Problems Holding You Back? — Google Business Profile Version",
    description:
    ...
    items: [
      {
        ...
        desc:
          "If your business doesn’t appear in Google Maps or local results, customers simply can’t find you.People expect complete details, good reviews, and regular updates — the basics of good Google Business Profile optimization.",
        image: "/images/low-visibilty.webp",
      },
      {
        title: "Incomplete or Outdated Business Information",
        desc:
          "Old phone numbers, missing hours, poor descriptions, or wrong categories can make you lose customers instantly. A well-maintained Google Business Profile makes your business look clear, active, and reliable.",
        image: "/images/outdated-business.webp",
      },
      {
        title: "No Clear Digital Strategy",
        desc:
          "An inactive profile gives the wrong impression. Without posts, updates, or reviews, your business looks silent. Regular activity helps your profile rank higher — something proper Google Business Profile optimization services handle easily.",
        image: "/images/no-post.webp",
      },
    ],
  },
  "ai-video-marketing": {
    heading: "Are These Problems Holding You Back? — AI Video Marketing Version",
    description:
    ...
    items: [
      {
        ...
        desc:
          "In order to produce a traditional video, one needs a significant amount of time, money and resources. With AI, there are no such barriers to creating high-quality video at a very quick speed and with minimal cost on your end.",
        image: "/images/slow-and-expensive-video.webp",
      },
      {
        title: "Weak or Unclear Marketing Videos",
        desc:
          "If your videos are slow, boring, or unclear, people won’t stay till the end because they don't understand your content. AI helps you to create best marketing videos that are sharp, well-paced, and easy to understand.",
        image: "/images/weak-or-unlocking.webp",
      },
      {
        title: "Low Engagement & Poor Conversion",
        desc:
          "People will not be engaged with your videos if they are not able to connect with them, thus meaning that they won't click on your video, view or share any of those videos or take any action afterward.",
        image: "/images/low-engagement.webp",
      },
    ],
  },
...
export const dynamicsServices = [
  ...
  },
  {
    ...
    subtitle: 'Company In Delhi NCR',
    description:
      `Great Mobile Applications can provide significant opportunities for all successful companies through the application of modern Interface / User Experience (UI/UX) principles and clean development methods as well as scalable technology combined with fast and efficient performance.We design and develop Mobile Applications in Delhi that enable our Clients to provide improved Customer Experience and significantly better Results.`,
    highlights: [
      'Mobile App Design',
      'Mobile App Development',
      'UI/UX for Mobile',
  ...
  },
  {
    ...
    subtitle: 'Agency in Delhi',
    description:
      `By targeting a right audience, increasing conversion rates through multiple techniques in Digital Marketing and creating trust, companies have the opportunity to grow their company and find increased contacts. Digital Marketing has the ability to greatly impact the success of your company on the Internet through comprehensive and focused campaigns, as well as by providing strong analysis of performance. Digital Marketing Agency based in New Delhi, helps businesses create a strategic roadmap for implementing digital marketing strategies and delivering continuous and consistent growth.`,
    highlights: [
      'SEO',
      'Social Media Marketing',
      'Google Ads',
  ...
  "website-designing-development": {
    ...
    content: {
      WebsiteDevelopment: {
        ...
        desc:
          "We create fast, modern, high-performing websites tailored for your business—designed for conversions, SEO, and an engaging user experience.",
        points: [
      ...
      Ecommerce: {
        ...
        desc:
          "We build powerful ecommerce websites that focus on smooth shopping experience, secure checkout, and high conversion rates.",
        points: [
      ...
      Web: {
        ...
        desc:
          "We provide monthly website maintenance including updates, security checks, bug fixes, backups, and speed enhancements.",
        points: [
      ...
      UIUX: {
        title: "UI UX Design",
        desc:
          "We design intuitive, modern, and visually engaging UI/UX interfaces that boost user satisfaction and improve conversion flow.",
        points: [
      ...
      Shopify: {
        ...
        desc:
          "We develop conversion-focused Shopify stores with custom themes, optimized product pages, and smooth checkout experience.",
        points: [
  ...
  "customize-crm-services": {
    ...
    content: {
      ...
      Customization: {
        ...
        desc:
          "Every business works differently. Custom CRM workflows ensure your system fits your sales process instead of forcing your team to adapt.",
        points: [
      ...
      Management: {
        ...
        desc:
          "A simple, clear system to track every inquiry from first contact to final conversion.",
        points: [
      ...
      Automation: {
        ...
        desc:
          "Automations help your team work faster with less mistakes and higher consistency.",
        points: [
      ...
      Pipeline: {
        ...
        desc:
          "Your full sales journey in a single view so your team always knows what to do next.",
        points: [
    ...
    steps: [
      {
        ...
        desc:
          "Share what you want to build. We understand your goals and connect you with the right expert for your project.",
      },
      {
        step: "Step 2",
        icon: "🧑‍💻",
        ...
        desc:
          "We share handpicked specialists. Review profiles and select the one that best fits your vision.",
      },
      {
        step: "Step 3",
        icon: "💬",
        ...
        desc:
          "Once finalized, onboarding is smooth and quick. Clear communication and full support from day one.",
      },
    ],
  },
  "customize-crm-services": {
